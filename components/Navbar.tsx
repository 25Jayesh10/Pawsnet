...
export default function Navbar() {
  ...
  const handleQRScan = (result: string) => {
    ...
    // For example, navigate to a specific page or show additional information
    ...
    <nav className="bg-white dark:bg-gray-800 shadow-md py-4 px-6">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <Link href="/pets" className="text-gray-700 dark:text-gray-200 hover:text-indigo-600 dark:hover:text-indigo-400">
            My Pets
          </Link>
          <Link href="/community" className="text-gray-700 dark:text-gray-200 hover:text-indigo-600 dark:hover:text-indigo-400">
            Community
          </Link>
          <Link href="/services" className="text-gray-700 dark:text-gray-200 hover:text-indigo-600 dark:hover:text-indigo-400">
            Services
          </Link>
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative">
            ...
            {showQRScanner && <QRScannerPopup onClose={() => setShowQRScanner(false)} onScan={handleQRScan} />}
          </div>
