  ...
  const events = [
    {
      ...
      participants: 12,
      description: 'Join us for our weekly feeding drive for stray animals in the city. We\'ll be providing food, water, and basic medical care.'
    },
    {
      id: 2,
      ...
      participants: 45,
      description: 'Find your perfect companion at our monthly adoption fair. Meet rescued animals looking for their forever homes.'
    },
    {
      id: 3,
      ...
      participants: 18,
      description: 'Learn safe and effective techniques for rescuing stray animals. Workshop includes hands-on training with professional rescuers.'
    }
  ];
    ...
    <>
      ...
      <main className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <section className="bg-indigo-600 text-white py-16">
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            <p className="text-lg max-w-3xl mx-auto mb-8">
              Together we can make a difference in the lives of pets and stray animals. 
              Connect with fellow animal lovers, participate in events, and contribute to our mission.
            </p>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300">Strays Rescued</p>
              </div>
        ...
        <section id="events" className="py-12 bg-gray-100 dark:bg-gray-800">
          <div className="max-w-7xl mx-auto px-6">
            <h2 className="text-2xl font-bold mb-8">Upcoming Community Events</h2>
        ...
        <section id="members" className="py-12">
          <div className="max-w-7xl mx-auto px-6">
            <h2 className="text-2xl font-bold mb-8">Meet Our Top Contributors</h2>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {members.map((member) => (
                <div key={member.id} className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 text-center">
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-300 mb-2">
                    <span className="font-medium">{member.animalsSaved}</span> animals saved
                  </div>
            ...
            <div className="mt-12 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg p-8 text-center">
              <h3 className="text-xl font-semibold mb-4">Want to Get Involved?</h3>
              <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mb-6">
                Join our community of animal lovers and make a difference in the lives of pets and stray animals. 
                Participate in events, share your experiences, and connect with like-minded individuals.
              </p>
              <Link 
                href="/community/join"
