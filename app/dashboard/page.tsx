...
import { FaPaw, FaCoins, FaPlus, FaExclamationTriangle, FaSearch } from 'react-icons/fa';
      ...
      <main className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <section className="relative py-16 bg-indigo-600 text-white">
          <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-0">
              <h1 className="text-3xl md:text-4xl font-bold mb-4">Welcome to Your Pet Community</h1>
        ...
        <section className="py-12">
          <div className="max-w-7xl mx-auto px-6">
            <h2 className="text-2xl font-bold mb-8 text-center">Your Community Impact</h2>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-indigo-50 dark:bg-indigo-900/30 p-4 rounded-lg text-center">
                    ...
                    <p className="text-gray-600 dark:text-gray-300">Community Services</p>
                  </div>
                  <div className="bg-green-50 dark:bg-green-900/30 p-4 rounded-lg text-center">
                    <div className="text-3xl font-bold text-green-600 dark:text-green-400 mb-2">
                      {communityStats.animalsSaved}
                    </div>
                    <p className="text-gray-600 dark:text-gray-300">Strays Helped</p>
                  </div>
                </div>
              </div>
        ...
        <section className="py-12 bg-gray-100 dark:bg-gray-800">
          <div className="max-w-7xl mx-auto px-6">
            <h2 className="text-2xl font-bold mb-8 text-center">Report & Help</h2>
                ...
                <div className="relative h-48">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end">
                    <div className="p-6 text-white">
                      <h3 className="text-xl font-bold mb-2">Report Stray Animal</h3>
                      <p className="mb-4">Help us locate and rescue stray animals in your area</p>
                    </div>
                  </div>
                </div>
                <div className="p-6">
                  <p className="text-gray-600 dark:text-gray-300 mb-4">
                    Spotted a stray animal that needs help? Report the sighting to our rescue team and earn community coins.
                  </p>
                ...
                <div className="relative h-48">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end">
                    <div className="p-6 text-white">
                      ...
                      <p className="mb-4">Get community help to find your missing pet</p>
                    </div>
                  </div>
                </div>
                <div className="p-6">
                  <p className="text-gray-600 dark:text-gray-300 mb-4">
                    Lost your pet? Report it immediately to alert our community members in your area to help in the search.
                  </p>
                  <div className="flex justify-between items-center">
        ...
        <section className="py-12">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {userPets.map((pet) => (
                <div key={pet.id} className="bg-white dark:bg-gray-700 rounded-lg shadow-md overflow-hidden">
              ...
              <div className="bg-gray-50 dark:bg-gray-600 border-2 border-dashed border-gray-300 dark:border-gray-500 rounded-lg flex flex-col items-center justify-center p-6">
                ...
                <p className="text-gray-500 dark:text-gray-300 text-center mb-4">Add another pet to your family</p>
                <Link 
                  href="/pets/add" 
                  className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300 font-medium"
                >
